    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='w-full max-w-md'>
          ...
          <CardContent className='pt-6'>
            <form onSubmit={handleSubmit} className='space-y-5'>
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 text-center'>
                ...
                <p className='text-sm text-blue-600 mt-1'>Username: <span className='font-mono font-semibold'>admin</span></p>
                <p className='text-sm text-blue-600'>Password: <span className='font-mono font-semibold'>admin</span></p>
              </div>
            </form>
          </CardContent>
        </Card>
        ...
        <p className='text-center text-sm text-gray-500 mt-6'>
          Powered by CWMS Authorization System
        </p>
      </div>
    </div>
  );
